...
type SpdkInstanceSpec struct {
	...
	// replica_address_map - RAID1 engine: maps replica name to address.
	// EC engine: single entry, value = ShardGroup endpoint "ip:port".
	...
	// slot_index - Shard instance: the EC array position (0-based) this shard
	// occupies. Determines the shard's role (DATA or PARITY) inside the
	// ShardGroup process when constructing the EC bdev.
	// Zero for engine, replica, shardgroup, and frontend instances.
	SlotIndex uint32 `protobuf:"varint,12,opt,name=slot_index,json=slotIndex,proto3" json:"slot_index,omitempty"`
	// lvs_name - Shard instance: SPDK bdev name of the target lvstore
	// (e.g. "block-diskn1", from node.Status.DiskStatus[*].DiskName).
	// The SPDK shard Create() validates lvs_name against the UUID lookup.
	// Empty for non-shard instances.
	LvsName string `protobuf:"bytes,13,opt,name=lvs_name,json=lvsName,proto3" json:"lvs_name,omitempty"`
	// lvs_uuid - Shard instance: SPDK lvstore UUID. Distinct from disk_uuid
	// (the Longhorn-level disk identifier). For V2 volumes the values are
	// identical in practice, but separate fields avoid an implicit naming
	// convention that could silently break if a future disk driver decouples
	// the two identifiers.
	// Empty for non-shard instances.
	LvsUuid string `protobuf:"bytes,14,opt,name=lvs_uuid,json=lvsUuid,proto3" json:"lvs_uuid,omitempty"`
	// shard_group_spec - ShardGroup instance: bdev_ec + lvstore + head lvol +
	// NVMe-oF expose creation parameters. Carries k+m shard endpoints, slot
	// indices, and a salvage_requested flag for RecreateEC semantics.
	// Nil for engine, replica, shard, and frontend instances.
	ShardGroupSpec *ShardGroupSpec `protobuf:"bytes,15,opt,name=shard_group_spec,json=shardGroupSpec,proto3" json:"shard_group_spec,omitempty"`
	...
	NvmeTcpNrIoQueues int32 `protobuf:"varint,16,opt,name=nvme_tcp_nr_io_queues,json=nvmeTcpNrIoQueues,proto3" json:"nvme_tcp_nr_io_queues,omitempty"`
	// data_engine_transport selects the NVMe-oF transport for the internal
	// engine<->replica data fabric. Set on both engine and replica instances so
	// the exporter (replica) and the connector (engine) agree. Forwarded to
	// spdkrpc.EngineCreateRequest / ReplicaCreateRequest.data_engine_transport.
	// Kept on the spec (not the request) because the delete path reads the spec
	// and must tear down the same transport it created. Unset (0) == TCP.
	DataEngineTransport DataEngineTransport `protobuf:"varint,17,opt,name=data_engine_transport,json=dataEngineTransport,proto3,enum=imrpc.DataEngineTransport" json:"data_engine_transport,omitempty"`
}
...
func (x *SpdkInstanceSpec) GetSlotIndex() uint32 {
	if x != nil {
		return x.SlotIndex
	}
	return 0
...
func (x *SpdkInstanceSpec) GetLvsName() string {
	if x != nil {
		return x.LvsName
	}
	return ""
...
func (x *SpdkInstanceSpec) GetLvsUuid() string {
	if x != nil {
		return x.LvsUuid
	}
	return ""
...
func (x *SpdkInstanceSpec) GetShardGroupSpec() *ShardGroupSpec {
	if x != nil {
		return x.ShardGroupSpec
	}
	return nil
}

func (x *SpdkInstanceSpec) GetNvmeTcpNrIoQueues() int32 {
	if x != nil {
...
func (x *SpdkInstanceSpec) GetDataEngineTransport() DataEngineTransport {
	if x != nil {
...
type InstanceCreateRequest struct {
	...
	// data_layout_type - set when InstanceSpec.type == "engine". Forwarded
	// to spdkrpc.EngineCreateRequest.data_layout_type so the engine selects
	// Replica vs. ShardGroup dispatch. Kept on the request rather than
	// SpdkInstanceSpec so the InstanceDelete path (which reads the spec)
	// behaves the same for EC and RAID1.
	DataLayoutType DataLayoutType `protobuf:"varint,2,opt,name=data_layout_type,json=dataLayoutType,proto3,enum=imrpc.DataLayoutType" json:"data_layout_type,omitempty"`
}
...
func (x *InstanceCreateRequest) GetDataLayoutType() DataLayoutType {
	if x != nil {
...
var file_imrpc_instance_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x67, 0x73, 0x22, 0xc7, 0x06, 0x0a, 0x10, 0x53, 0x70, 0x64, 0x6b, 0x49, 0x6e, 0x73,
	...
	,
	...
	0x04, 0x0a, 0x0c, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x12,
	...
	,
	...
	0x69, 0x72, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x75, 0x70, 0x67, 0x72,
	...
	,
	...
	0x1b, 0x0a, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x69, 0x70, 0x18, 0x02, 0x20, 0x01,
	...
	0x05, 0x52, 0x0a, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x10, 0x0a,
	0x03, 0x6e, 0x71, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6e, 0x71, 0x6e, 0x12,
	0x14, 0x0a, 0x05, 0x6e, 0x67, 0x75, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x6e, 0x67, 0x75, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x6e, 0x61, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x6e, 0x61, 0x53, 0x74, 0x61,
	0x74, 0x65, 0x22, 0xcf, 0x05, 0x0a, 0x0e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x73, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x6f, 0x72, 0x74,
	0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x6f,
	0x72, 0x74, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x72, 0x74, 0x5f,
	0x65, 0x6e, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x70, 0x6f, 0x72, 0x74, 0x45,
	0x6e, 0x64, 0x12, 0x45, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x69, 0x6d, 0x72, 0x70, 0x63, 0x2e, 0x49,
	...
	,
	...
	0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x3f, 0x0a, 0x10, 0x64, 0x61, 0x74, 0x61, 0x5f,
	0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x15, 0x2e, 0x69, 0x6d, 0x72, 0x70, 0x63, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x61,
	0x79, 0x6f, 0x75, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0e, 0x64, 0x61, 0x74, 0x61, 0x4c, 0x61,
	0x79, 0x6f, 0x75, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xa0, 0x02, 0x0a, 0x15, 0x49, 0x6e, 0x73,
	...
	,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xf0, 0x01,
	...
	0x72, 0x65, 0x73, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x5f, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x6e, 0x67, 0x69, 0x6e,
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x6f,
	0x76, 0x65, 0x72, 0x5f, 0x70, 0x68, 0x61, 0x73, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0f, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x6f, 0x76, 0x65, 0x72, 0x50, 0x68, 0x61, 0x73, 0x65,
	0x22, 0x79, 0x0a, 0x1b, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x44, 0x65, 0x6c, 0x65,
	...
	,
	...
	0x65, 0x6c, 0x22, 0x48, 0x0a, 0x12, 0x4c, 0x6f, 0x67, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x61, 0x67,
	...
	0x28, 0x09, 0x52, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x32, 0x93, 0x09, 0x0a, 0x0f, 0x49, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x49, 0x0a,
	0x0e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x0e, 0x49, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x1c, 0x2e, 0x69, 0x6d, 0x72,
	...
	,
	...
	0x0f, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x75, 0x73, 0x70, 0x65, 0x6e, 0x64,
	...
	,
	...
	,
	...
	0x65, 0x12, 0x44, 0x0a, 0x0b, 0x4c, 0x6f, 0x67, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x61, 0x67, 0x73,
	0x12, 0x19, 0x2e, 0x69, 0x6d, 0x72, 0x70, 0x63, 0x2e, 0x4c, 0x6f, 0x67, 0x47, 0x65, 0x74, 0x46,
	0x6c, 0x61, 0x67, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x69, 0x6d,
	0x72, 0x70, 0x63, 0x2e, 0x4c, 0x6f, 0x67, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x0a, 0x56, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x47, 0x65, 0x74, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	...
	0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x6f,
	0x6e, 0x67, 0x68, 0x6f, 0x72, 0x6e, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70, 0x6b, 0x67,
	0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x2f, 0x69, 0x6d, 0x72, 0x70, 0x63,
...
var file_imrpc_instance_proto_goTypes = []interface{}{
	...
	(*ShardGroupSpec)(nil),                  // 25: imrpc.ShardGroupSpec
	(DataEngineTransport)(0),                // 26: imrpc.DataEngineTransport
	(BackendStoreDriver)(0),                 // 27: imrpc.BackendStoreDriver
	(DataEngine)(0),                         // 28: imrpc.DataEngine
	(DataLayoutType)(0),                     // 29: imrpc.DataLayoutType
	(*emptypb.Empty)(nil),                   // 30: google.protobuf.Empty
	(*LogResponse)(nil),                     // 31: LogResponse
	(*VersionResponse)(nil),                 // 32: VersionResponse
}
var file_imrpc_instance_proto_depIdxs = []int32{
	...
	25, // 1: imrpc.SpdkInstanceSpec.shard_group_spec:type_name -> imrpc.ShardGroupSpec
	26, // 2: imrpc.SpdkInstanceSpec.data_engine_transport:type_name -> imrpc.DataEngineTransport
	27, // 3: imrpc.InstanceSpec.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	...
	28, // 6: imrpc.InstanceSpec.data_engine:type_name -> imrpc.DataEngine
	23, // 7: imrpc.InstanceStatus.conditions:type_name -> imrpc.InstanceStatus.ConditionsEntry
	3,  // 8: imrpc.InstanceStatus.paths:type_name -> imrpc.EngineFrontendNvmeTcpPath
	2,  // 9: imrpc.InstanceCreateRequest.spec:type_name -> imrpc.InstanceSpec
	29, // 10: imrpc.InstanceCreateRequest.data_layout_type:type_name -> imrpc.DataLayoutType
	27, // 11: imrpc.InstanceDeleteRequest.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	28, // 12: imrpc.InstanceDeleteRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 13: imrpc.InstanceGetRequest.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	28, // 14: imrpc.InstanceGetRequest.data_engine:type_name -> imrpc.DataEngine
	2,  // 15: imrpc.InstanceResponse.spec:type_name -> imrpc.InstanceSpec
	4,  // 16: imrpc.InstanceResponse.status:type_name -> imrpc.InstanceStatus
	24, // 17: imrpc.InstanceListResponse.instances:type_name -> imrpc.InstanceListResponse.InstancesEntry
	27, // 18: imrpc.InstanceLogRequest.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	28, // 19: imrpc.InstanceLogRequest.data_engine:type_name -> imrpc.DataEngine
	2,  // 20: imrpc.InstanceReplaceRequest.spec:type_name -> imrpc.InstanceSpec
	28, // 21: imrpc.InstanceSuspendRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 22: imrpc.InstanceResumeRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 23: imrpc.InstanceSwitchOverTargetRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 24: imrpc.InstanceDeleteTargetRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 25: imrpc.LogSetLevelRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 26: imrpc.LogSetFlagsRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 27: imrpc.LogGetLevelRequest.data_engine:type_name -> imrpc.DataEngine
	28, // 28: imrpc.LogGetFlagsRequest.data_engine:type_name -> imrpc.DataEngine
	8,  // 29: imrpc.InstanceListResponse.InstancesEntry.value:type_name -> imrpc.InstanceResponse
	5,  // 30: imrpc.InstanceService.InstanceCreate:input_type -> imrpc.InstanceCreateRequest
	6,  // 31: imrpc.InstanceService.InstanceDelete:input_type -> imrpc.InstanceDeleteRequest
	7,  // 32: imrpc.InstanceService.InstanceGet:input_type -> imrpc.InstanceGetRequest
	30, // 33: imrpc.InstanceService.InstanceList:input_type -> google.protobuf.Empty
	10, // 34: imrpc.InstanceService.InstanceLog:input_type -> imrpc.InstanceLogRequest
	30, // 35: imrpc.InstanceService.InstanceWatch:input_type -> google.protobuf.Empty
	11, // 36: imrpc.InstanceService.InstanceReplace:input_type -> imrpc.InstanceReplaceRequest
	12, // 37: imrpc.InstanceService.InstanceSuspend:input_type -> imrpc.InstanceSuspendRequest
	13, // 38: imrpc.InstanceService.InstanceResume:input_type -> imrpc.InstanceResumeRequest
	14, // 39: imrpc.InstanceService.InstanceSwitchOverTarget:input_type -> imrpc.InstanceSwitchOverTargetRequest
	15, // 40: imrpc.InstanceService.InstanceDeleteTarget:input_type -> imrpc.InstanceDeleteTargetRequest
	16, // 41: imrpc.InstanceService.LogSetLevel:input_type -> imrpc.LogSetLevelRequest
	17, // 42: imrpc.InstanceService.LogSetFlags:input_type -> imrpc.LogSetFlagsRequest
	18, // 43: imrpc.InstanceService.LogGetLevel:input_type -> imrpc.LogGetLevelRequest
	20, // 44: imrpc.InstanceService.LogGetFlags:input_type -> imrpc.LogGetFlagsRequest
	30, // 45: imrpc.InstanceService.VersionGet:input_type -> google.protobuf.Empty
	8,  // 46: imrpc.InstanceService.InstanceCreate:output_type -> imrpc.InstanceResponse
	8,  // 47: imrpc.InstanceService.InstanceDelete:output_type -> imrpc.InstanceResponse
	8,  // 48: imrpc.InstanceService.InstanceGet:output_type -> imrpc.InstanceResponse
	9,  // 49: imrpc.InstanceService.InstanceList:output_type -> imrpc.InstanceListResponse
	31, // 50: imrpc.InstanceService.InstanceLog:output_type -> LogResponse
	30, // 51: imrpc.InstanceService.InstanceWatch:output_type -> google.protobuf.Empty
	8,  // 52: imrpc.InstanceService.InstanceReplace:output_type -> imrpc.InstanceResponse
	30, // 53: imrpc.InstanceService.InstanceSuspend:output_type -> google.protobuf.Empty
	30, // 54: imrpc.InstanceService.InstanceResume:output_type -> google.protobuf.Empty
	30, // 55: imrpc.InstanceService.InstanceSwitchOverTarget:output_type -> google.protobuf.Empty
	30, // 56: imrpc.InstanceService.InstanceDeleteTarget:output_type -> google.protobuf.Empty
	30, // 57: imrpc.InstanceService.LogSetLevel:output_type -> google.protobuf.Empty
	30, // 58: imrpc.InstanceService.LogSetFlags:output_type -> google.protobuf.Empty
	19, // 59: imrpc.InstanceService.LogGetLevel:output_type -> imrpc.LogGetLevelResponse
	21, // 60: imrpc.InstanceService.LogGetFlags:output_type -> imrpc.LogGetFlagsResponse
	32, // 61: imrpc.InstanceService.VersionGet:output_type -> VersionResponse
