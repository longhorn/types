...
type SpdkInstanceSpec struct {
	...
	RestrictHostAcl bool `protobuf:"varint,16,opt,name=restrict_host_acl,json=restrictHostAcl,proto3" json:"restrict_host_acl,omitempty"`
}
...
func (x *SpdkInstanceSpec) GetRestrictHostAcl() bool {
	if x != nil {
...
var file_imrpc_instance_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x67, 0x73, 0x22, 0xf1, 0x05, 0x0a, 0x10, 0x53, 0x70, 0x64, 0x6b, 0x49, 0x6e, 0x73,
	...
	0x75, 0x70, 0x53, 0x70, 0x65, 0x63, 0x12, 0x2a, 0x0a, 0x11, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69,
	0x63, 0x74, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x61, 0x63, 0x6c, 0x18, 0x10, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0f, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x41,
	0x63, 0x6c, 0x1a, 0x44, 0x0a, 0x16, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x41, 0x64, 0x64,
	...
	0x01, 0x28, 0x08, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x81,
	0x01, 0x0a, 0x15, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x63, 0x12, 0x3f, 0x0a, 0x10, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x69, 0x6d,
	0x72, 0x70, 0x63, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x0e, 0x64, 0x61, 0x74, 0x61, 0x4c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x22, 0xa0, 0x02, 0x0a, 0x15, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x44,
...
var file_imrpc_instance_proto_goTypes = []interface{}{
	...
	(BackendStoreDriver)(0),                 // 26: imrpc.BackendStoreDriver
	(DataEngine)(0),                         // 27: imrpc.DataEngine
	(DataLayoutType)(0),                     // 28: imrpc.DataLayoutType
...
var file_imrpc_instance_proto_depIdxs = []int32{
	...
	26, // 2: imrpc.InstanceSpec.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	...
	27, // 5: imrpc.InstanceSpec.data_engine:type_name -> imrpc.DataEngine
	23, // 6: imrpc.InstanceStatus.conditions:type_name -> imrpc.InstanceStatus.ConditionsEntry
	3,  // 7: imrpc.InstanceStatus.paths:type_name -> imrpc.EngineFrontendNvmeTcpPath
	2,  // 8: imrpc.InstanceCreateRequest.spec:type_name -> imrpc.InstanceSpec
	28, // 9: imrpc.InstanceCreateRequest.data_layout_type:type_name -> imrpc.DataLayoutType
	26, // 10: imrpc.InstanceDeleteRequest.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	27, // 11: imrpc.InstanceDeleteRequest.data_engine:type_name -> imrpc.DataEngine
	26, // 12: imrpc.InstanceGetRequest.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	27, // 13: imrpc.InstanceGetRequest.data_engine:type_name -> imrpc.DataEngine
	2,  // 14: imrpc.InstanceResponse.spec:type_name -> imrpc.InstanceSpec
	4,  // 15: imrpc.InstanceResponse.status:type_name -> imrpc.InstanceStatus
	24, // 16: imrpc.InstanceListResponse.instances:type_name -> imrpc.InstanceListResponse.InstancesEntry
	26, // 17: imrpc.InstanceLogRequest.backend_store_driver:type_name -> imrpc.BackendStoreDriver
	27, // 18: imrpc.InstanceLogRequest.data_engine:type_name -> imrpc.DataEngine
	2,  // 19: imrpc.InstanceReplaceRequest.spec:type_name -> imrpc.InstanceSpec
	27, // 20: imrpc.InstanceSuspendRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 21: imrpc.InstanceResumeRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 22: imrpc.InstanceSwitchOverTargetRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 23: imrpc.InstanceDeleteTargetRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 24: imrpc.LogSetLevelRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 25: imrpc.LogSetFlagsRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 26: imrpc.LogGetLevelRequest.data_engine:type_name -> imrpc.DataEngine
	27, // 27: imrpc.LogGetFlagsRequest.data_engine:type_name -> imrpc.DataEngine
	8,  // 28: imrpc.InstanceListResponse.InstancesEntry.value:type_name -> imrpc.InstanceResponse
	5,  // 29: imrpc.InstanceService.InstanceCreate:input_type -> imrpc.InstanceCreateRequest
	6,  // 30: imrpc.InstanceService.InstanceDelete:input_type -> imrpc.InstanceDeleteRequest
	7,  // 31: imrpc.InstanceService.InstanceGet:input_type -> imrpc.InstanceGetRequest
	29, // 32: imrpc.InstanceService.InstanceList:input_type -> google.protobuf.Empty
	10, // 33: imrpc.InstanceService.InstanceLog:input_type -> imrpc.InstanceLogRequest
	29, // 34: imrpc.InstanceService.InstanceWatch:input_type -> google.protobuf.Empty
	11, // 35: imrpc.InstanceService.InstanceReplace:input_type -> imrpc.InstanceReplaceRequest
	12, // 36: imrpc.InstanceService.InstanceSuspend:input_type -> imrpc.InstanceSuspendRequest
	13, // 37: imrpc.InstanceService.InstanceResume:input_type -> imrpc.InstanceResumeRequest
	14, // 38: imrpc.InstanceService.InstanceSwitchOverTarget:input_type -> imrpc.InstanceSwitchOverTargetRequest
	15, // 39: imrpc.InstanceService.InstanceDeleteTarget:input_type -> imrpc.InstanceDeleteTargetRequest
	16, // 40: imrpc.InstanceService.LogSetLevel:input_type -> imrpc.LogSetLevelRequest
	17, // 41: imrpc.InstanceService.LogSetFlags:input_type -> imrpc.LogSetFlagsRequest
	18, // 42: imrpc.InstanceService.LogGetLevel:input_type -> imrpc.LogGetLevelRequest
	20, // 43: imrpc.InstanceService.LogGetFlags:input_type -> imrpc.LogGetFlagsRequest
	29, // 44: imrpc.InstanceService.VersionGet:input_type -> google.protobuf.Empty
	8,  // 45: imrpc.InstanceService.InstanceCreate:output_type -> imrpc.InstanceResponse
	8,  // 46: imrpc.InstanceService.InstanceDelete:output_type -> imrpc.InstanceResponse
	8,  // 47: imrpc.InstanceService.InstanceGet:output_type -> imrpc.InstanceResponse
	9,  // 48: imrpc.InstanceService.InstanceList:output_type -> imrpc.InstanceListResponse
	...
	8,  // 51: imrpc.InstanceService.InstanceReplace:output_type -> imrpc.InstanceResponse
	...
	19, // 58: imrpc.InstanceService.LogGetLevel:output_type -> imrpc.LogGetLevelResponse
	21, // 59: imrpc.InstanceService.LogGetFlags:output_type -> imrpc.LogGetFlagsResponse
